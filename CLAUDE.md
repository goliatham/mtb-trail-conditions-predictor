...
**YOU ARE IN: `mtb_trail_conditions_predictor/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/mtb_trail_conditions_predictor/` (rig root) or other directories
...
**Your mail address:** `mtb_trail_conditions_predictor/polecats/furiosa`
**Your rig:** mtb_trail_conditions_predictor
**Your Witness:** `mtb_trail_conditions_predictor/witness`
...
| Ask Witness for help | `gt mail send mtb_trail_conditions_predictor/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`mtb_trail_conditions_predictor/witness`) when:
...
```bash
gt mail send mtb_trail_conditions_predictor/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
...
Rig: mtb_trail_conditions_predictor
Polecat: furiosa
Role: polecat
